...
Eigen::Vector3d P01, P12, P23, P34, P45, P56, P6e, P0e, zero, P0ee;
...
void getJacobian() {
  ...
  Jev << CrossProduct(R01*k, (P0ecom-P01+P0ee)), CrossProduct(R02*k, (P0ecom-P02+P0ee)), CrossProduct(R03*k, (P0ecom-P03+P0ee)), CrossProduct(R04*k, (P0ecom-P04+P0ee)), CrossProduct(R05*k, (P0ecom-P05+P0ee)), CrossProduct(R06*k, (P0ecom-P06+P0ee));
...
void getJacobian_dot(const Eigen::VectorXd& gc, const Eigen::VectorXd& gv) {
  ...
  Jev_dot << CrossProduct(CrossProduct(J1a*gv, R01*k),(P0ecom-P01+P0ee)) + CrossProduct(R01*k, Jev*gv-J1v2*gv), CrossProduct(CrossProduct(J2a*gv, R02*k),(P0ecom-P02+P0ee)) + CrossProduct(R02*k, Jev*gv-J2v2*gv), CrossProduct(CrossProduct(J3a*gv, R03*k),(P0ecom-P03+P0ee)) + CrossProduct(R03*k, Jev*gv-J3v2*gv), CrossProduct(CrossProduct(J4a*gv, R04*k),(P0ecom-P04+P0ee)) + CrossProduct(R04*k, Jev*gv-J4v2*gv), CrossProduct(CrossProduct(J5a*gv, R05*k),(P0ecom-P05+P0ee)) + CrossProduct(R05*k, Jev*gv-J5v2*gv), CrossProduct(CrossProduct(J6a*gv, R06*k),(P0ecom-P06+P0ee)) + CrossProduct(R06*k, Jev*gv-J6v2*gv);
...
inline Eigen::VectorXd getGeneralizedForce (const raisim::ArticulatedSystem* robot) {
  ...
  Externel_Force << 0, 0, 10;
  calculate(robot->getGeneralizedCoordinate().e());
  getJacobian();
  getJacobian_dot(robot->getGeneralizedCoordinate().e(), robot->getGeneralizedVelocity().e());
  M << robot->getMassMatrix().e();
  C << robot->getNonlinearities().e();

  Eigen::MatrixXd A = (Jev*M.inverse()).completeOrthogonalDecomposition().pseudoInverse();
  Eigen::MatrixXd B = (Jev*M.inverse()*C-Jev*M.inverse()*Jev.transpose()*Externel_Force-Jev_dot*(robot->getGeneralizedVelocity().e()));
