...
int main(int argc, char* argv[]) {
  ...
  gc << 0, 0, 10.54, 0.0, 1.0, 0.0, 0.0, 0.07, 0.15, -0.54, -0.23, 0.34, -0.21, 0.43, 0.21, 0.2, 0.13, 0.43, -0.5;
  gv << 0.1, 0.2, 0.45, 0.2, 0.2, 0.3, 0.123,0.151,0.065, 0.1,-0.2,-0.1, 0.1,0.5,0.5, 0.3,0.1,0.2;
  ...
  for (int i=0; i<2000000; i++) {
    ...
    std::cout<<"foot velocity driven : " << getFootLinearVelocity(gc,gv) << std::endl;


    std::cout<<"foot angular velocity "<<footAngVel<<std::endl;
    std::cout<<"foot angular velocity driven : " << getFootAngularVelocity(gc,gv) << std::endl;
